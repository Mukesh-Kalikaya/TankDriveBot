...
public class RobotContainer {
  ...
  private final Teleop teleop = new Teleop(drive);
  private final ExampleSubsystem m_exampleSubsystem = new ExampleSubsystem();
  private final static Servo boxController = Constants.boxController;
    ...
    public static double openBox() {
      if (m_driverController.leftBumper().getAsBoolean()) {
        return boxController.setSpeed(1);
      } else {
        return 0;
      }
  }
